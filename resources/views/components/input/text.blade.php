...
<div class="flex rounded-md shadow-sm">
    @if ($leadingAddOn)
        <span class="{{ $theme == 'light' ? 'border-charcoal text-gray-500' : 'border-yellow-50 text-yellow-50' }}
    ...
    {{ $theme == 'light' ? 'border-charcoal focus:bg-yellow-100 text-charcoal' : 'border-yellow-100 text-yellow-50 focus:border-yellow-50' }}
