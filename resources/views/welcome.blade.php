<x-layout>
    <section class="py-10 mx-auto max-w-screen-xl px-4 sm:py-12 sm:px-6 md:py-16 lg:py-20 xl:py-28">
        <div class="text-center">
            <h2 class="font-cursive text-4xl tracking-tight leading-10 font-extrabold text-charcoal sm:text-5xl sm:leading-none md:text-6xl">
                Browse the best courses in
                <br/>
                the <span class="text-orange-400">Laravel ecosystem
          </span>
            </h2>
            <p class="font-cursive mt-3 max-w-md mx-auto text-base text-charcoal text-lg sm:text-xl md:mt-5 md:text-2xl md:max-w-3xl">
